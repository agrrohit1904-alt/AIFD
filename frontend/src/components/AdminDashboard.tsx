    ...
    <div className="max-w-7xl mx-auto p-6">
      <header className="mb-8 flex justify-between items-end">
        <div>
          ...
          <p className="text-gray-500 mt-2">Administrative view of all verification attempts</p>
        </div>
        <button onClick={fetchLogs} className="text-sm bg-white border border-gray-300 px-4 py-2 rounded hover:bg-gray-50 text-gray-700 shadow-sm">
          Refresh Logs
        </button>
      </header>
                ...
                <tr key={log.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm">
                    {log.face_status === 'auto_approve' ? (
                      ...
                      <span className="text-gray-500 capitalize">{log.face_status.replace('_', ' ')}</span>
                    )}
                  </td>
                </tr>
              ))
